...
/* SMMLAR */
#define multAcc_32x32_keep31_R(a, x, y) \
    a = (q31_t) (((((q63_t) a) << 31) + ((q63_t) x * y) + 0x80000000LL ) >> 31)

/* SMMLSR */
#define multSub_32x32_keep31_R(a, x, y) \
    a = (q31_t) (((((q63_t) a) << 31) - ((q63_t) x * y) + 0x80000000LL ) >> 31)

/* SMMULR */
#define mult_32x32_keep31_R(a, x, y) \
    a = (q31_t) (((q63_t) x * y + 0x80000000LL ) >> 31)
