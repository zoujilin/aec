  ...
  uint32_t twidCoefModifier)
{
  ...
  do
  {
    ...
    /*  Butterfly implementation */
    /* xa + xc */
    r1 = (pSi0[0] >> 0U) + (pSi2[0] >> 0U);
    /* xa - xc */
    r2 = (pSi0[0] >> 0U) - (pSi2[0] >> 0U);

    /* xb + xd */
    t1 = (pSi1[0] >> 0U) + (pSi3[0] >> 0U);

    /* ya + yc */
    s1 = (pSi0[1] >> 0U) + (pSi2[1] >> 0U);
    /* ya - yc */
    s2 = (pSi0[1] >> 0U) - (pSi2[1] >> 0U);
    ...
    *pSi0++ = (s1 + t2);
    ...
    /* yb - yd */
    t1 = (pSi1[1] >> 0U) - (pSi3[1] >> 0U);
    /* xb - xd */
    t2 = (pSi1[0] >> 0U) - (pSi3[0] >> 0U);
  ...
  for (k = fftLen / 4U; k > 4U; k >>= 2U)
  {
    ...
    for (j = 0U; j <= (n2 - 1U); j++)
    {
      ...
      for (i0 = j; i0 < fftLen; i0 += n1)
      {
        ...
        /* xc' = (xa-xb+xc-xd)co2 + (ya-yb+yc-yd)(si2) */
        pSi1[0] = (((int32_t) (((q63_t) r1 * co2) >> 31)) +
                         ((int32_t) (((q63_t) s1 * si2) >> 31))) >> 0U;

        /* yc' = (ya-yb+yc-yd)co2 - (xa-xb+xc-xd)(si2) */
        pSi1[1] = (((int32_t) (((q63_t) s1 * co2) >> 31)) -
                                ((int32_t) (((q63_t) r1 * si2) >> 31))) >> 0U;
        pSi1 += 2 * n1;
        ...
        /* xb' = (xa+yb-xc-yd)co1 + (ya-xb-yc+xd)(si1) */
        pSi2[0] = (((int32_t) (((q63_t) r1 * co1) >> 31)) +
                         ((int32_t) (((q63_t) s1 * si1) >> 31))) >> 0U;

        /* yb' = (ya-xb-yc+xd)co1 - (xa+yb-xc-yd)(si1) */
        pSi2[1] = (((int32_t) (((q63_t) s1 * co1) >> 31)) -
                                ((int32_t) (((q63_t) r1 * si1) >> 31))) >> 0U;
        pSi2 += 2 * n1;

        /* xd' = (xa-yb-xc+yd)co3 + (ya+xb-yc-xd)(si3) */
        pSi3[0] = (((int32_t) (((q63_t) r2 * co3) >> 31)) +
                         ((int32_t) (((q63_t) s2 * si3) >> 31))) >> 0U;

        /* yd' = (ya+xb-yc-xd)co3 - (xa-yb-xc+yd)(si3) */
        pSi3[1] = (((int32_t) (((q63_t) s2 * co3) >> 31)) -
                                ((int32_t) (((q63_t) r2 * si3) >> 31))) >> 0U;
        pSi3 += 2 * n1;
      }
    }
    twidCoefModifier <<= 2U;
